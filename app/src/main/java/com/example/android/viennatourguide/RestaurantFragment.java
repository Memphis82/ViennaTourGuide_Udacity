...
public class RestaurantFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        data.add(new Data("Spelunke", "Herrengasse", R.drawable.ic_local_hotel_black_24dp, 25.093163, 55.159065));
        data.add(new Data("Flatchers", "Ring", -1, 25.093163, 55.159065));
        data.add(new Data("Weinschenke", "Donauufer", -1, 25.093163, 55.159065));
        data.add(new Data("Wild", "Graben", -1, 25.093163, 55.159065));
